...
// add one parameter int* mvs at last
X264_API int x264_encoder_encode_modified( x264_t *, x264_nal_t **pp_nal, int *pi_nal, x264_picture_t *pic_in, x264_picture_t *pic_out, int* mvs);
/* x264_encoder_close:
